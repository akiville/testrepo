...
namespace Qtc.Branch.Dal
{
    ...
    public static class AppConfiguration
    {
        ...
        public static string ConnectionStringName
        {
            get
            {
                return ConfigurationManager.AppSettings["pt.Api.Connection"];
            }
        }
        ...
        public static string ConnectionLogisticsStringName
        {
            get
            {
                return ConfigurationManager.AppSettings["pt.Api.LogConnection"];
            }
        }
        ...
        public static string ConnectionSignatureStringName
        {
            get
            {
                return ConfigurationManager.AppSettings["Paotsin.Systems.SignaturesConnection"];
            }
        }
        ...
        public static string ConnectionCommonStringName
        {
            get
            {
                return ConfigurationManager.AppSettings["Paotsin.Systems.CommonConnection"];
            }
        }
        ...
        public static string DBProviderName
        {
            get
            {
                return ConfigurationManager.AppSettings["pt.Api.DBProvider"];
            }
        }
        #endregion
